...
#default_10-17_15:31_0.994444444444:conv2D kernel1x1,seg0.951 default_10-18_23:32_0.99375.h5:seg0.9868:size369




#to2D_train.creatXceptionModel(mode=None, weights_h5=None, train=True)
to2D_train.creatXceptionModel(mode=None, weights_h5='default_10-18_23:32_0.99375.h5', evaluate=False, train=False)
#to2D_train.creatXceptionModel(mode='out74', weights_h5='out74_09-01_20:34_0.98935462472.h5', train=False)
...
:return: print and plt show result
'''
#to2D_train.segImgDir(imgPath+'test/jzl')
#exit(0)

#to2D_train.segImgDir(imgPath+'test/heyude1015pm/2/2-1')

#to2D_train.segImgfile(imgPath+'temp/UNADJUSTEDNONRAW_thumb_294b.jpg') #32  294b
#to2D_train.imgPredict2DShow(imgPath+'temp/UNADJUSTEDNONRAW_thumb_294b.jpg')
